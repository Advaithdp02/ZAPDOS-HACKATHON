                ...
                <div className="space-y-6 py-4">
                  <div className="flex items-center gap-4">
                     <Avatar className="h-20 w-20">
                      <AvatarImage src={PlaceHolderImages.find(p => p.id === selectedStudent.studentId)?.imageUrl || `https://picsum.photos/seed/${selectedStudent.studentId}/80/80`} alt={selectedStudent.name} />
